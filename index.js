...
const ownersArray = ['', '361039024288432138', ''];
        const adminsRole = [""]; // ايدي رول السبورت .
   const serverID = "991546882218262559"; // ايدي سيرفر البُوتات .
...
client83883.on("ready", () => {
  client83883.user.setPresence({
    ...
    activities: [{
      name: `AboNasser`,
      type: "STREAMING", url: "https://www.twitch.tv/abonassser99"
    }]
  })
})
